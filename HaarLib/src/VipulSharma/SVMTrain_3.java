 ...
 */
public class SVMTrain_3 {

//    public static void main(String[] args) {
    public SVMTrain_3(String[] args) {
        // Load the native OpenCV library
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        // Set up training data
        int[] labels = {1, -1, -1, -1};
        float[] trainingData = {501, 10, 255, 10, 501, 255, 10, 501};
        float[] trainingData2 = {511, 11, 215, 11, 511, 215, 11, 511};
        Mat trainingDataMat = new Mat(4, 2, CvType.CV_32FC1);
        Mat trainingDataMat2 = new Mat(4, 2, CvType.CV_32FC1);
        trainingDataMat.put(0, 0, trainingData);
        trainingDataMat2.put(0, 0, trainingData2);
        ...
        svm.save("E:\\TA\\h2.csv");
//        svm = SVM.load("E:\\TA\\h2.csv");
        svm.train(trainingDataMat2, Ml.ROW_SAMPLE, labelsMat);
        svm.save("E:\\TA\\h2.xml");
